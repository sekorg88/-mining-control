...
| **TT-Miner** | EPIC, EVR | [tradeproject.de](https://tradeproject.de/) |
...
- Up-to-date NVIDIA drivers (download: [nvidia.com/drivers](https://www.nvidia.com/drivers))
...
- Актуальные драйверы NVIDIA (скачать: [nvidia.com/drivers](https://www.nvidia.com/drivers))
